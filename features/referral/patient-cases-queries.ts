...
export async function getPatientCasesByPatientId(patientId: number) {
  "use cache";
  cacheTag("patient-cases");
  cacheLife("minutes");
...
export async function getPatientCaseById(caseId: number) {
  "use cache";
  cacheTag("patient-cases");
  cacheLife("minutes");
...
export async function getPatientWithCases(patientId: number) {
  "use cache";
  cacheTag("patient-cases");
  cacheLife("minutes");
...
export async function getPatientCasesByReferringPhysicianId(referringPhysicianId: number) {
  "use cache";
  cacheTag("patient-cases");
  cacheLife("minutes");
